...
jQuery(document).ready(function ($) {
  ...
  $(document).on('click', '.btn-disable-activation', function () {
    ...
    $.get({
      url: "https://zoomthe.me/updater_dzsap/check_activation.php?purchase_code=" + $('*[name=dzsap_purchase_code]').val() + '&site_url=' + encodeURIComponent(dzsap_settings.site_url) + '&action=dzsap_purchase_code_disable',
  ...
  $(document).on('submit', '.activate-form', function () {
    ...
    var url = "https://zoomthe.me/updater_dzsap/check_activation.php?purchase_code=" + $('*[name=dzsap_purchase_code]').val() + '&site_url=' + encodeURIComponent(dzsap_settings.site_url);
    $.get({
      url,
      success: function (data) {
