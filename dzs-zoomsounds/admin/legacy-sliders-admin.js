...
jQuery(document).ready(function ($) {
  ...
  $('.import-export-db-con .the-toggle').click(function () {
    var _t = $(this);
    var $contentMask = _t.parent().children('.the-content-mask');

    if ($contentMask.hasClass('content-mask-visible'))
      $contentMask.removeClass('content-mask-visible');
    else
      $contentMask.addClass('content-mask-visible');
