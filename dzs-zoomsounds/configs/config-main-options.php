...
return array(
  ...
  'enable_aux_buttons' => array(
    ...
    'extra_classes' => '',
    'sidenote' => sprintf(esc_html__('enable auxiliarry stats / analytics / delete button under each songs to see the stats', DZSAP_ID), '/', 'wp-content/dzsap_backups'),
  ),
  'activate_comments_widget' => array(
    ...
    'default' => 'off',
    'select_type' => ' ',
    'title' => esc_html__('Activate Analytics Widget', DZSAP_ID),
    'extra_classes' => '',
    'sidenote' => esc_html__('views, likes, comments widget in the wordpress dashboard', DZSAP_ID),
  ),
  ...
  'player_pause_method' => array(
    ...
    'default' => 'canvas',
    'select_type' => ' ',
    'title' => esc_html__('Pause method', 'dzsap'),
  ...
  'analytics_enable' => array(
    'type' => 'checkbox',
    'category' => 'settings_social',
    'default' => 'off',
    'title' => esc_html__('Enable Analytics', DZSAP_ID),
    'extra_classes' => '',
    'sidenote' => esc_some_html__("activate analytics for the galleries, for players will need for %sEnable Extra Stats / Delete%s button to be enabled", array('<strong>', '</strong>')),
  ),

  'analytics_enable_location' => array(
    'type' => 'checkbox',
    'category' => 'settings_social',
    'default' => 'off',
    'title' => esc_html__('Track Users Country?', DZSAP_ID),
    'extra_classes' => '',
    'sidenote' => esc_html__("use geolocation to track users country", DZSAP_ID),
  ),

  'analytics_enable_user_track' => array(
    'type' => 'checkbox',
    'category' => 'settings_social',
    'default' => 'off',
    'title' => esc_html__('Track Statistic by User?', DZSAP_ID),
    'extra_classes' => '',
    'sidenote' => esc_html__("track views and minutes watched of each user", DZSAP_ID),
  ),

  'analytics_track_only_once' => array(
    'type' => 'checkbox',
    'category' => 'settings_social',
    'default' => 'on',
    'title' => esc_html__('Allow only one play per IP / session ', DZSAP_ID),
    'extra_classes' => '',
    'sidenote' => esc_html__("disable in order to allow the play count to increase on reload", DZSAP_ID),
  ),
