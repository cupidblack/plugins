...
return array(
  ...
  'loop_playlist' => array(
    ...
    'description' =>  esc_html__('by default when the last item has ended, the first will start', DZSAP_ID),
    'canBeEmptyString' => false,
    ...
    'options' => array(
      array(
        'label' => esc_html__("Loop", DZSAP_ID),
        'value' => 'on',
      ),
      array(
        'label' => esc_html__("Do not loop", DZSAP_ID),
        'value' => 'off',
      ),
    ),
  ),
