...
//		}
	...
	function admin_page_about() {
		...
		// Expose AJAX nonce to admin JS so JS can send it with AJAX requests (security: dzsap_admin_action_nonce)
		wp_localize_script( 'admin-page--about', 'dzsapAdminSettings', array(
			'ajax_nonce' => wp_create_nonce( 'dzsap_admin_action_nonce' ),
