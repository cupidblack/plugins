  ...
  <div class="import-export-db-con">
    ...
    <div class="the-content-mask" style="">
      ...
      <div class="the-content">
        <h2><?php echo esc_html__("Whole Database", DZSAP_ID); ?></h2>
        <form enctype="multipart/form-data" action="" method="POST">

          <div class="">
            <h3><?php echo esc_html__("Import Whole Database", DZSAP_ID); ?></h3>
        ...
        <div class="">
          <h3><?php echo esc_html__("Export Whole Database", DZSAP_ID); ?></h3>
        </div>
        <div class="">
        ...
        <br>
        <br>
        <h1><?php echo esc_html__("OR", DZSAP_ID); ?></h1>
        <br>
        <br>


        <h2><?php echo esc_html__("Single Slider", DZSAP_ID); ?></h2>


        <form enctype="multipart/form-data" action="" method="POST">
          <div class="">
            <h3><?php echo esc_html__("Import a Single Slider", DZSAP_ID); ?></h3>
  ...
  <div class="top-buttons">
    ...
    <div class="super-select db-select dzsap">
      ...
      <select class="main-select hidden"><?php
        ...
        ?></select>
      <div hidden class=" replaceurlhelper"><?php
